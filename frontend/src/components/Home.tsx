...
export const Home: React.FC<HomeProps> = ({ onGetStarted }) => {
  ...
  <div className="border-4 border-dashed border-gray-200 dark:border-slate-600 rounded-lg p-6 sm:p-8 text-center bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
